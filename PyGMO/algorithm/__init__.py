...
def _cmaes2_ctor(
    ...
    USAGE: algorithm.cmaes2(gen = 500, cc = -1, cs = -1, c1 = -1, cmu = -1, sigma0=0.5, ftol = 1e-6, xtol = 1e-6, memory = False, screen_output = False, min_inj_rank = 0)
    ...
    * 		 different island outputs)
    ...
    arg_list.append(xtol)
    arg_list.append(memory)
    arg_list.append(min_inj_rank)
    self._orig_init(*arg_list)
    self.screen_output = screen_output
cmaes2._orig_init = cmaes2.__init__
cmaes2.__init__ = _cmaes2_ctor
